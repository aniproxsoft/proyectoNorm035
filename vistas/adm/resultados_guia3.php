  ...
  <?php?>
      ...
      <body>
          ...
          <div class="container-norma"  id="contenedor" name="con1" style="display: block;">      
            <div class="card">
              <h4 class="card-header"><strong>Calificaciones de la Guía de Referencia III de <?php echo $empleado[0]['nombre_completo']?></strong></h4>              
              <div class="card-body">    
               
                <a class="btn btn-primary bt-sm" 
                <?php echo '<a href="respuestas_guia3.php?num='. base64_encode ($empleado[0]['num_empleado']).'"'  ?>

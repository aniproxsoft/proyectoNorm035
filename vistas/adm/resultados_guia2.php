...
if (!isset($sesion)) {
    ...
    $global=$ctrlEmpleados->getResultadosGlobalGuia2($num_empleado);
    $categorias=$ctrlEmpleados->getResultadosCategoriaGuia2($num_empleado);
    $dominios=$ctrlEmpleados->getResultadosDominioGuia2($num_empleado);

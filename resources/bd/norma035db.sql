...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_autentification` (`empleado_num` VARCHAR(500), `pass` VARCHAR(255))  BEGIN
...
(123456, 'Luis Manuel', 'Fernandez Hernandez', 55, 'M', 7, '1', 2, 1, '1'),
(12345678, 'Gerarado', 'Pluma Bautista', 53, 'M', 7, '1', 2, 2, '1');
